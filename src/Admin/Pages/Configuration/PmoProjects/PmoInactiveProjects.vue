          ...
          <tr>
            ...
            <td>
              <div class="min_width_120">
                {{ props.item.manager_details.Full_Code }}
              </div>
            </td>
            <td>
              <div class="min_width_120 text-capitalize">
                {{ props.item.client_name }}
              </div>
            </td>
            <td>
              {{ props.item.start_date |formatDate}}
            </td>
            <td>
              <v-tooltip
                bottom
              ...
              >
                <template v-slot:activator="{ on }">
                  <div class="description_hover_div" v-on="on" v-html="props.item.description">

                  </div>
                </template>
                <v-sheet v-html="props.item.description" class="pa-4 b"></v-sheet>
              </v-tooltip>
              <span v-else>{{ $t("not_appllicable") }}</span>
            </td>
            <td>
              {{ props.item.resource_allocation_count }}
            </td>
              ...
              <div class="d-flex justify-space-between align-items-center">
                <!-- <div>
                  <router-link
                    ...
                    x-small
                    class="mr-2 primary hover_shine"
                  >
                ...
                <v-tooltip bottom>
                  ...
                  <v-switch v-model="props.item.active_flag" color="success" readonly>
                  </v-switch>
            ...
            <td v-if="user_role.includes('HR')"  class="text-center px-0">
              <router-link
                small
                :to="{
                  name: 'project.amend',
...
export default {
  props: ["status", "inactive_proj","search","user_role"],
  data: () => ({
    isDisabled: false,
    loader: "",
    delete_id: "",
      ...
      axios
        ...
        .then((res) => {
          ...
          if (res.data.status == "S") {
            ...
            this.$emit("display_active",false);
            this.initval = false;
