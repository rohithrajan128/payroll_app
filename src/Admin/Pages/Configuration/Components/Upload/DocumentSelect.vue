      ...
      <div>
        <v-card>
          <v-card-title style="justify-content: space-between">
            <span class="headline">Document Upload</span>
  ...
  methods: {
    ...
    save() {
      ...
      if (this.selectedtype == "Videos") {
        ...
        console.log("file doc typr", this.selectedfile.name);
        ...
        axios
          ...
          .then((res) => {
            ...
            this.loader=false;
              this.$emit("uploadedDocument", res.data.filepath);
              this.$emit("uploadedFileType", this.selectedtype);
              this.$emit("uploadedDocumentName",this.selectedfile.name);
              console.log("file doc typr",  res.data);
            }
          })
          .catch((err) => {
            console.log(err);
